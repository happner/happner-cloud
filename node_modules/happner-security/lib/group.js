...
GroupManager.prototype.create = function($happn, params, callback) {
	...
	var updateEventData = {channel:_const.CHANNEL.GROUP, 
...
GroupManager.prototype.update = function($happn, params, callback) {
	...
	try{
		...
		if (!_groups[params.data.name]) throw new Error('group does not exist');

		var group = _groups[params.data.name];
		group.description = params.data.description;
		group.permissions = params.data.permissions;
