...
UserManager.prototype.addGroup = function($happn, params, callback){
	callback(null);
}

UserManager.prototype.removeGroup = function($happn, params, callback){
	callback(null);
}
...
UserManager.prototype.__cache = null;
